...
const EditTaskForm: React.FC<Props> = ({onEdit, onAbort, prevTask, loading}) => {
    ...
    return (
        <div>
            ...
            <div className={s.buttons}>
                <Button loading={loading} icon={<FontAwesomeIcon icon={faCircleCheck}/>} onClick={editHandler}>Save</Button>
                <Button icon={<FontAwesomeIcon icon={faCircleXmark}/>} onClick={onAbort}>Cancel</Button>
            </div>
        </div>
    );
};
